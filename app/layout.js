  ...
  return (
   <html lang="en" className={dmSans.variable}>
      <body className="antialiased min-h-screen w-full bg-base100">
        <div className="mx-auto gap-x-2 flex max-w-[1440px] min-h-screen">
          {/* Sidebar */}
          ...
          {/* Main Content Area */}
          <main className="flex-1 relative bg-base100 w-full mt-1 ml-1">
            {/* Fixed Header */}
            ...
            <section className="mt-[4rem] h-[calc(100vh-4rem)] overflow-y-auto p-4 xl:px-2">
              {children}
            </section>
          </main>
        </div>
